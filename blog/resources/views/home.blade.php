    ...
    <div class="app-container">
        <div class="app-header">
          <div class="app-header-left">
            ...
            <p class="app-name">Tableau de bord</p>
          ...
          <div class="app-header-right">
            ...
            <button class="profile-btn">
              <img src="https://media-exp1.licdn.com/dms/image/C4D03AQEwSpkbqA9xQg/profile-displayphoto-shrink_400_400/0/1606044844683?e=1625702400&v=beta&t=eBdUi7X0VZBvQvfR9X060LF57IVmTD7GAEG_FtkbIDQ" />
              <span>Christian OUPOH</span>
            </button>
          </div>
        ...
        <div class="app-content">
          <div class="app-sidebar">
            ...
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="app-sidebar-link">
